    ...
    <header class="header">
      ...
      <div class="header-right">
        <nav class="header-nav">
          <router-link to="/pages/user/home" class="nav-item">Trang chủ</router-link>
          <router-link to="/pages/user/courses" class="nav-item">Trang khóa thi</router-link>
          <router-link to="/pages/user/contact" class="nav-item">Liên hệ</router-link>
        </nav>
        <div id="loginOut">
          <div class="btn-login">
            <router-link to="/pages/user/sign-in" class="nav-item">Đăng nhập</router-link>
            <router-link to="/pages/user/sign-up" class="nav-item">Đăng ký</router-link>
          </div>
          <div class="user-info">
            <img
              src=""
...
// All functionality removed; only the UI is retained
</script>
