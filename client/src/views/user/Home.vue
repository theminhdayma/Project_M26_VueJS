<template>
  <div>
    ...
    <section class="attend-exam">
      <h1 style="text-align: center">Đề thi tiêu biểu</h1>
      <div id="attendSubject" class="attend-list">
        <router-link to="/pages/user/exam/1">
          <div class="card" style="width: 18rem; padding: 10px">
            ...
            <div class="card-body">
              <h4>Đề thi 1</h4>
              <span id="sequence">Lượt thi: 1</span>
            </div>
          </div>
        </router-link>
        <router-link to="/pages/user/exam/2">
          <div class="card" style="width: 18rem; padding: 10px">
            <img
              src=""
              class="card-img-top"
            ...
            <div class="card-body">
              <h4>Đề thi 2</h4>
              <span id="sequence">Lượt thi: 2</span>
            </div>
          </div>
        </router-link>
        <router-link to="/pages/user/exam/3">
          <div class="card" style="width: 18rem; padding: 10px">
            <img
              src=""
              class="card-img-top"
            ...
            <div class="card-body">
              <h4>Đề thi 3</h4>
              <span id="sequence">Lượt thi: 3</span>
            </div>
          </div>
        </router-link>
        <router-link to="/pages/user/exam/4">
          <div class="card" style="width: 18rem; padding: 10px">
            <img
              src=""
              class="card-img-top"
            ...
            <div class="card-body">
              <h4>Đề thi 4</h4>
              <span id="sequence">Lượt thi: 4</span>
            </div>
          </div>
        </router-link>
      </div>
