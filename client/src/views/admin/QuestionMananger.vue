    ...
    <div class="container-content-admin">
      ...
      <section class="attendance" style="width: 80%">
        <div class="attendance-list">
          <h1 class="manage-title">Quản lí câu hỏi</h1>
          <button class="btn-add">Thêm câu hỏi</button>
          ...
          <div class="pagination">
            <button class="page-button">&laquo; Trang trước</button>
            <button class="page-button active">1</button>
            <button class="page-button">2</button>
            <button class="page-button">3</button>
            <button class="page-button">Trang sau &raquo;</button>
          </div>
        </div>
      </section>
    </div>
